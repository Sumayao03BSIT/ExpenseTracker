<template>
    <div class="flex justify-center items-center min-h-screen bg-black">
      <div class="container mx-auto p-8 bg-black rounded-lg shadow-lg border border-black-300 bg-blue">
        <h1 class="text-5xl text-center text-white mb-10">Expense Tracker</h1>
        <div class="flex">
          ...
          <div class="flex-1 relative"> 
            <div class="expenses-table-container border border-gray-300">
              <table class="w-full">
                <thead>
                  <tr>
                    <th class="border border-gray-300 px-4 py-2 text-white">Item</th>
                    <th class="border border-gray-300 px-4 py-2 text-white">Category</th>
                    <th class="border border-gray-300 px-4 py-2 text-white">Amount</th>
                    <th class="border border-gray-300 px-4 py-2 text-white">EDIT</th>
                  </tr>
                </thead>
                <tbody>
  ...
  <style scoped>
    .input-field {
      ...
      width: 100%;
      font-size: 16px;
      box-shadow: 0 0 5px rgba(1, 33, 28, 0.5);  
